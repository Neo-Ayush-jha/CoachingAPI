                        ...
                        <div class="row">
                            <div class="col-12">
                                <form accept-charset="UTF-8" action="/payment" class="require-validation"
                                    data-cc-on-file="false" {{-- data-stripe-publishable-key="SET_YOUR_PUBLISHED_KEY_HERE" --}}
                                    data-stripe-publishable-key="pk_test_51KqEClSIJqriEVmB6DVYHQJsZzgXbKjoHjeAZRO7p4RfjM2eroYrYnXPBmbXjR8zMatM13LoePRnIZ9tZwafYFeP00bRptcHfr"
        ...
        $(function() {
            ...
            function stripeResponseHandler(status, response) {
                if (response.error) {
                    ...
                    $form.append("<input type='hidden' name='stripeToken' value='" + token + "'/payment>");
                    console.log(token);
                    $form.get(0).submit();
                }
            }
